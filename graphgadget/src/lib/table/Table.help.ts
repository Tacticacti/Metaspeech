...
export function getHeaderDeleteButton(r: RenderResult<sut>, header: string): HTMLButtonElement | null {
...
export async function renameColumn(r: RenderResult<sut>, oldName: string, newName: string): Promise<void> {
